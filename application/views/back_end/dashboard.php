...
<link rel="stylesheet" type = "text/css" href = "<?php echo base_url(); ?>css/back_end/bootstrap.min.css"> 
<link rel="stylesheet"  type="text/css" href="<?php echo base_url(); ?>css/back_end/bootstrap-responsive.min.css" />
<link rel="stylesheet"  type="text/css" href="<?php echo base_url(); ?>css/back_end/fullcalendar.css" />
<link rel="stylesheet"  type="text/css" href="<?php echo base_url(); ?>css/back_end/matrix-style.css" />
<link rel="stylesheet"  type="text/css" href="<?php echo base_url(); ?>css/back_end/matrix-media.css" />
<link href="<?php echo base_url(); ?>font/backend_font/css/font-awesome.css" rel="stylesheet" />
<link rel="stylesheet" href="<?php echo base_url();?>css/back_end/jquery.gritter.css" />
...
<script src="<?php echo base_url(); ?>js/backend_js/excanvas.min.js"></script> 
<script src="<?php echo base_url(); ?>js/backend_js/jquery.min.js"></script> 
<script src="<?php echo base_url(); ?>js/backend_js/jquery.ui.custom.js"></script> 
<script src="<?php echo base_url(); ?>js/backend_js/bootstrap.min.js"></script> 
<script src="<?php echo base_url(); ?>js/backend_js/jquery.flot.min.js"></script> 
<script src="<?php echo base_url(); ?>js/backend_js/jquery.flot.resize.min.js"></script> 
<script src="<?php echo base_url(); ?>js/backend_js/jquery.peity.min.js"></script> 
<script src="<?php echo base_url(); ?>js/backend_js/fullcalendar.min.js"></script> 
<script src="<?php echo base_url(); ?>js/backend_js/matrix.js"></script> 
<script src="<?php echo base_url(); ?>js/backend_js/matrix.dashboard.js"></script> 
<script src="<?php echo base_url(); ?>js/backend_js/jquery.gritter.min.js"></script> 
<script src="<?php echo base_url(); ?>js/backend_js/matrix.interface.js"></script> 
<script src="<?php echo base_url(); ?>js/backend_js/matrix.chat.js"></script> 
<script src="<?php echo base_url(); ?>js/backend_js/jquery.validate.js"></script> 
<script src="<?php echo base_url(); ?>js/backend_js/matrix.form_validation.js"></script> 
<script src="<?php echo base_url(); ?>js/backend_js/jquery.wizard.js"></script> 
<script src="<?php echo base_url(); ?>js/backend_js/jquery.uniform.js"></script> 
<script src="<?php echo base_url(); ?>js/backend_js/select2.min.js"></script> 
<script src="<?php echo base_url(); ?>js/backend_js/matrix.popover.js"></script> 
<script src="<?php echo base_url(); ?>js/backend_js/jquery.dataTables.min.js"></script> 
<script src="<?php echo base_url(); ?>js/backend_js/matrix.tables.js"></script> 
